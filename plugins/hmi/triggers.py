...
components_touch_event = [
        #MainPage
        {"page_id": MainPage.id, "component_id": MainPage.id, "touch_event": 0, "call_back": MainPage.onRelease},
        {"page_id": MainPage.id, "component_id": MainPage.id, "touch_event": 1, "call_back": MainPage.onTouch},
